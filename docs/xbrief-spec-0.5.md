...
1. The root object contains a `xBRIEFInfo` field with `version` equal to `"0.5"`.
...
- **[xBRIEF JSON Schema]** — [../schemas/xbrief-core.schema.json](../schemas/xbrief-core.schema.json)
...
The normative JSON Schema for xBRIEF v0.5 is located at [`schemas/xbrief-core.schema.json`](../schemas/xbrief-core.schema.json).
